  ...
  <StickyContainer id="techDiv">
    ...
    <div className="text-center tech container fadeIn">
      <ul className="techList row">
        ...
        <li className="col-md-3">MongoDB <br /><img src="https://i2.wp.com/www.damiencosset.com/wp-content/uploads/2017/07/mongodb.png?fit=413%2C484&ssl=1" alt="mongodb" /></li>
