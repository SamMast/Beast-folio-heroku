    ...
    return (
      <div>
        <div className="samLogo">
          <a href="/" >
            <img src="https://raw.githubusercontent.com/SamMast/Beast-folio-heroku/master/client/public/images/sam-08.png" alt="logo" className="logoImage zoomer" style={styles.logoStyle}/>
          </a>
        </div>
